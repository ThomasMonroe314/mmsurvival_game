...
local function switch_night_sensor(a_position, a_player_name)
	...
	core.chat_send_player(a_player_name, "-- You switch "..temp_message.." the night sensor.")
end
...
minetest.register_node("travail:nightlight", {
	...
	on_rightclick = function(a_position, a_node, a_clicker, a_itemstack, a_pointed_thing)
		...
		if not core.is_protected(a_position, temp_player_name) then
			...
			switch_night_sensor(a_position, temp_player_name)
		end
	end,
